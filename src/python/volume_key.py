...
class Packet(_object):
    ...
    __swig_getmethods__["open_unencrypted"] = lambda x: _volume_key.Packet_open_unencrypted
    if _newclass:open_unencrypted = staticmethod(_volume_key.Packet_open_unencrypted)
...
def Packet_open_unencrypted(*args):
  return _volume_key.Packet_open_unencrypted(*args)
